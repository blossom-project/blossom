...
public class MenuItemBuilder {
    ...
    public MenuItem build() {
        return new MenuItemImpl(registry, key, icon, label, i18n, link, order, parent);
    }
    ...
    public static class MenuItemImpl implements MenuItem {
        ...
        MenuItemImpl(PluginRegistry<MenuItem, String> registry, String key, String icon, String label, boolean i18n, String link, int order, MenuItem parent) {
            this.registry = registry;
            this.key = key;
            this.icon = icon;
            this.label = label;
