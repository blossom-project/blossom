...
<div class="wrapper wrapper-content">
  <form id="roleCreateForm" class="form form-horizontal" novalidate method="POST">
    ...
    <div class="ibox">
      <div class="ibox-content">
        ...
        <div class="form-group <#if spring.status.error>has-error</#if>">
          ...
          <div class="col-sm-10">
            <input type="text" name="name" class="form-control" value="${roleCreateForm.name}"
        ...
        <div class="form-group <#if spring.status.error>has-error</#if>">
          ...
          <div class="col-sm-10">
            <input type="text" name="description" class="form-control" value="${roleCreateForm.description}"
