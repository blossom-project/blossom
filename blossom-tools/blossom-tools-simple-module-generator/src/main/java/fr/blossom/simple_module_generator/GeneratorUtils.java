...
public class GeneratorUtils {
  ...
  private final static String PACKAGE_IMPL = "impl";
  private final static String PACKAGE_DTO = "dto";
  private final static String PACKAGE_MODEL = "model";
  private final static String PACKAGE_DAO = "dao";
  private final static String PACKAGE_REPOSITORY = "repository";
  private final static String PACKAGE_PROCESS = "process";
  private final static String PACKAGE_SERVICE = "service";
  private final static String PACKAGE_CONFIGURATION = "configuration";

  /* Module webservices informations */
  private final static String BASE_PACKAGE_WS = "fr.lotus.bo.ui.ws";
