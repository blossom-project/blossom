package com.blossom_project.generator;

import com.blossom_project.generator.configuration.GeneratorBuilder;
...
public class GeneratorExample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    builder
      .settings()
      .basePackage("com.blossom_project.sample.testmael")
      .entityName("TestMael")
