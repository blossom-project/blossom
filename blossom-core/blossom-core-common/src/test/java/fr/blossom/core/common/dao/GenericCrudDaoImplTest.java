...
public class GenericCrudDaoImplTest {
    ...
    public void should_update_with_success() {
        ...
        when(this.repository.getOne(anyLong())).thenReturn(toUpdate);
    ...
    public void should_update_with_wrong_id() {
        ...
        when(this.repository.getOne(anyLong())).thenReturn(null);
    ...
    public void should_update_with_wrong_entity_id() {
        thrown.expect(IllegalArgumentException.class);
        Long id = 1L;
        when(this.repository.getOne(anyLong())).then(arg -> {
    ...
    public void should_update_with_null_entity() {
        thrown.expect(IllegalArgumentException.class);
        when(this.repository.getOne(anyLong())).thenReturn(new ENTITY());
    ...
    public void should_create_list_with_empty_collection() {
        ...
        when(this.repository.saveAll(eq(toCreate))).thenReturn(Lists.newArrayList());
